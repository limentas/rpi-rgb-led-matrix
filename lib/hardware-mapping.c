...
struct HardwareMapping matrix_hardware_mappings[] = {
  ...
  
  {
    ...
    /* Parallel chain 0, RGB for both sub-panels */
    .p0_r1         = GPIO_BIT(7),  /* masks: SPI0_SCKL  */
    .p0_g1         = GPIO_BIT(27),  /* Not on RPi1, Rev1; use "regular-pi1" instead */
    .p0_b1         = GPIO_BIT(11),   /* masks: SPI0_CE1   */
    .p0_r2         = GPIO_BIT(10),   /* masks: SPI0_CE0   */
    .p0_g2         = GPIO_BIT(9),   /* masks: SPI0_MISO  */
    ...
    /* Chain 2 */
    .p2_r1         = GPIO_BIT(3), /* masks TxD when parallel=3 */
    .p2_g1         = GPIO_BIT(2),  /* masks SCL when parallel=3 */
    .p2_b1         = GPIO_BIT(14),  /* masks SDA when parallel=3 */
    .p2_r2         = GPIO_BIT(21),
    .p2_g2         = GPIO_BIT(16),
    .p2_b2         = GPIO_BIT(26),
  },
